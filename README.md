...
(NaN loss, divergence, stalls, OOM), explains the failure, escalates over SMS + AI voice
note, and — if you don't respond before the deadline — spawns parallel Cursor cloud agents
...
├── apps/api/             # FastAPI relay: keys, SMS, voice-note pages
